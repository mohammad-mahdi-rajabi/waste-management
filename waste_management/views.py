...
from .serializers import (
    ...
    ClientSummarySerializer, ClientDetailSerializer, UserFullDetailSerializer, UserDetailSerializer,
    UserSummarySerializer, ChangeUserPasswordSerializer,
    ...
    LanguageSerializer, CalendarSerializer, CalendarEventSerializer, ContactUsSerializer, SectionSerializer,
    StaticChoiceSerializer, StaticChoiceOptionSerializer,

    VehicleTypeSerializer, VehicleInfoSerializer, AssociateTypeSerializer, ContractTypeSerializer,
    WasteStorageTypeSerializer,
    WasteAnalysisParameterSerializer, WasteAnalysisPreparationStandardSerializer,
    WasteAnalysisPreparationMethodSerializer,
    WasteAnalysisStandardSerializer, WasteAnalysisMethodSerializer, LabAnalysisResultSerializer,
    WasteTreatmentMaterialSerializer,
    WasteTreatmentEquipmentSerializer, WasteTreatmentMethodSerializer, AssociateOfClientDetailSerializer,
    AssociateOfClientSummarySerializer,
    ...
    WasteBatchSecondaryEvaluationSerializer, WasteAssessmentSerializer, WasteSampleSerializer,
    WasteBatchCostEstimationSerializer,
    ...
    LandfillDailyReportSerializer, CustomerOfClientEvaluationSerializer, HSEAccidentTypeSerializer,
    HSEAccidentReportSerializer,
    WasteSubBatchSummarySerializer, WasteBatchSummarySerializer, LabSummarySerializer,
    PaymentRecievedSerializer, PaymentInstallmentSerializer, ContractCommencementSerializer,
...
from .models import (
    ...
    WasteAnalysisPreparationStandard,
    WasteAnalysisPreparationMethod, WasteAnalysisStandard, WasteAnalysisMethod, LabAnalysisResult,
    WasteTreatmentMaterial,
    WasteTreatmentEquipment, WasteTreatmentMethod, AssociateOfClient, Contract, Payment, WasteClassificationSystem,
    WasteClass,
    ...
    WasteBatchStorageEnter,
    WasteBatchStorageExit, WasteBatchTreatment, Lab, WasteBatchTCLPTestResult, WasteBatchLandfilling,
    LandfillDailyReport, CustomerOfClientEvaluation,
